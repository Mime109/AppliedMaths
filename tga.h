...
class TGAImg
 {
  public:
   TGAImg();
   ~TGAImg();
   int Save(char *filename, short int width, short int height, unsigned char pixelDepth, unsigned char *imageData);
...
int TGAImg::Save(char *filename, short int width, short int height, unsigned char pixelDepth, unsigned char *imageData)
{
